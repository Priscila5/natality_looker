view: mothers_natality {
  sql_table_name: `natality.mothers_natality` ;;
  ...
  dimension: mothers_single_race {
    type: string
    sql: ${TABLE}.Mothers_Single_Race ;;
  }
  dimension: mothers_single_race_code {
    type: string
    sql: ${TABLE}.Mothers_Single_Race_Code ;;
  }
