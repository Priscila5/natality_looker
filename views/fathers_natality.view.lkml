view: fathers_natality {
  sql_table_name: `natality.fathers_natality` ;;
  ...
  dimension: fathers_single_race {
    type: string
    sql: ${TABLE}.Fathers_Single_Race ;;
  }
  dimension: fathers_single_race_code {
    type: string
    sql: ${TABLE}.Fathers_Single_Race_Code ;;
  }
